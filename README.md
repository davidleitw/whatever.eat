...
2. **傳送位置**：在對話中點選「位置」並分享你的當前位置
3. **獲得推薦**：機器人會自動搜尋附近餐廳並推薦一家給你
4. **查看詳情**：推薦訊息包含餐廳名稱、評分、地址、營業時間和 Google Maps 連結
...
🏷️ Types: restaurant, food, establishment
💰 Price Level: 3
...
🔗 Google Maps: https://maps.google.com/maps?cid=...
```
